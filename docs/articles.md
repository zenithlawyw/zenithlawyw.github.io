...
<ul>
  <li><strong>Author:</strong> <a class="-mx-1 inline-flex min-h-[45px] items-center rounded px-1" href="{{ '/authors/zenith-law/' | relative_url }}">Zenith Law</a></li>
  <li><strong>Site and policy context:</strong> <a class="-mx-1 inline-flex min-h-[45px] items-center rounded px-1" href="{{ '/legal/' | relative_url }}">Legal Notices</a></li>
</ul>
